...
void InfoBar::showEvent(QShowEvent *event)
{
    ...
    if (m_position != InfoBarPosition::INFOBAR_NONE) {
...
InfoBarManagerBase &InfoBarManagerFactory::factory(InfoBarPosition postion)
{
    ...
    switch (postion) {
        case InfoBarPosition::INFOBAR_TOP:
            return topInfoBarManager;
        case InfoBarPosition::INFOBAR_BOTTOM:
            return bottomInfoBarManager;
        case InfoBarPosition::INFOBAR_TOP_RIGHT:
            return topRightInfoBarManager;
        case InfoBarPosition::INFOBAR_BOTTOM_RIGHT:
            return bottomRightInfoBarManager;
        case InfoBarPosition::INFOBAR_TOP_LEFT:
            return topLeftInfoBarManager;
        case InfoBarPosition::INFOBAR_BOTTOM_LEFT:
